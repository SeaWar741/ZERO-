...
//___________________________________Rojo___________________________________
	...
	void get_posB2(){ //ready
	    api.getMyZRState(myState);
	        ...
	        if ((myState[0] < posB2[0]) && (myState[1] > posB2[1]) && (myState[2] < posB2[2])) {
	...
	void get_posC2(){
	    ...
	    api.getMyZRState(myState);
	        for (int i=0; i<3; i++){
	       	...
	       	if ((myState[0] > posC2[0]) && (myState[1] > posC2[1]) && (myState[2] < posC2[2])) {
	        //if ((myState[0] =! posC2[0]) && (myState[1] =! posC2[1]) && (myState[2] =! posC2[2])) {	        	
